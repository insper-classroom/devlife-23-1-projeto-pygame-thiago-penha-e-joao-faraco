...
class Tela_Primavera():
    '''
    A classe Tela_Primavera representa a tela do jogo correspondente à fase de primavera. Ela possui diversos métodos responsáveis por criar e desenhar os elementos que compõem a tela, tais como plataformas, moedas, monstros e outros objetos.
...
chaoGroup: grupo de sprites do chão.
    ...
    def desenha_bolinha(self):
        ...
        if self.frequenciadotiro%200==0:
