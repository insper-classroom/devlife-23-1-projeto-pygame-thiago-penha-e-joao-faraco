...
class Plataforma(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y):
        pygame.sprite.Sprite.__init__(self)
        self.image=pygame.transform.scale(pygame.image.load('docs/imagens/plataforma_verao.png'),(150,50)).convert_alpha()
        self.rect=self.image.get_rect()
        self.rect.topleft=(x,y)
...
class Tela_Verao():
    '''
    A classe Tela_Verão representa a tela do jogo correspondente à fase de primavera. Ela possui diversos métodos responsáveis por criar e desenhar os elementos que compõem a tela, tais como plataformas, moedas, monstros e outros objetos.
...
chaoGroup: grupo de sprites do chão.
    ...
    def __init__(self,fonte):
        self.imagem=pygame.transform.scale(pygame.image.load('docs/imagens/floresta_teste.webp'),(3000,410)).convert_alpha()
    ...
    def desenha_bolinha(self):
        ...
        '''
        self.frequenciadotiro+=1
        if self.frequenciadotiro%150==0:
