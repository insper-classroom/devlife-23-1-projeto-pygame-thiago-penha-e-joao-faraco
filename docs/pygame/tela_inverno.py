...
class Tela_Inverno():
    '''
    A classe Tela_Inverno representa a tela do jogo correspondente à fase de primavera. Ela possui diversos métodos responsáveis por criar e desenhar os elementos que compõem a tela, tais como plataformas, moedas, monstros e outros objetos.
